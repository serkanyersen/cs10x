...
import { Trie } from "./data-structures/trie.ts";
import { BinaryTree } from "./data-structures/binary-search-tree.ts";
import { Stack } from "./data-structures/stack.ts";
import { Queue } from "./data-structures/queue.ts";
import { LinkedList } from "./data-structures/linked-list.ts";
import { MinHeap } from "./data-structures/min-heap.ts";
import {
  inOrder,
  levelOrder,
  outOrder,
